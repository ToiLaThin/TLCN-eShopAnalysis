...
namespace eShopAnalysis.ProductCatalogAPI.Infrastructure
{
    public interface ICatalogRepository : IRepository<Catalog>
    {
        ...
        Task<IEnumerable<Catalog>> FindAsync(Expression<Func<Catalog, bool>> predicate);
        ...
        Task<Catalog> AddAsync(Catalog catalog, IClientSessionHandle sessionHandle = null);
        ...
        Task<IEnumerable<Catalog>> AddRangeAsync(IEnumerable<Catalog> catalogs, IClientSessionHandle sessionHandle = null);

        bool Remove(Guid catalog, IClientSessionHandle sessionHandle = null);

        Task<bool> RemoveAsync(Guid catalog, IClientSessionHandle sessionHandle = null);

        bool Update(Catalog catalog, IClientSessionHandle sessionHandle = null);

        Task<bool> UpdateAsync(Catalog catalog, IClientSessionHandle sessionHandle = null);
    }
}
