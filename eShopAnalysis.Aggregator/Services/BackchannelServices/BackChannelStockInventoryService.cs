...
namespace eShopAnalysis.ApiGateway.Services.BackchannelServices
{
    public class BackChannelStockInventoryService : IBackChannelStockInventoryService
    {
        ...
        public BackChannelStockInventoryService(IBackChannelBaseService<OrderItemsStockRequestDto, IEnumerable<ItemStockResponseDto>> baseService, IOptions<BackChannelCommunication> backChannelUrls)
        {
